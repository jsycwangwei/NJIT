...
<div class="loginTop" <?php echo GetLoginBg(); ?>>
	<div class="logo"><a href="http://www.1haosj.com" target="_blank"><img src="templates/images/logo.png"></a></div>
</div>
<div class="loginWarp">
	<div class="loginArea">
		...
		<div class="loginForm">
			...
			<div class="loginThanks">感谢您使用<span>南京互联网技术社区</span>产品</div>
		</div>
	</div>
</div>
<div class="loginCopyright">© 2015 NJITGROUP.cn</div>
</body>
</html>